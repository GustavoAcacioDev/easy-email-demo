...
export default function Editor() {
  ...
  const handleImageUpload = async (data) => {
    const imageUrl = await uploadImageAndGetURL(data);
    return imageUrl;
  };

  async function uploadImageAndGetURL(data) {
    return "https://s3-sa-east-1.amazonaws.com/fidelimax/PadroesSistema/LogoMedio.gif";
  }
